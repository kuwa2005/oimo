...
export const dict = {
  ...
  "tui.dialog.auto_mode.hint": "none / normal / fde / special — セッション途中の切替でも goal を維持（再起動なし）",
  ...
  "tui.dialog.auto_mode.option.normal.desc": "ヒアリング先行（あなたに質問) -> 要件ロック後にノンストップ",
  ...
  "tui.dialog.auto_mode.toast.normal": "オートモード: normal（ヒアリング先行）",
