...
export const dict = {
  ...
  "tui.prompt.interrupt_again": "もう一度で中断",
  "tui.prompt.retry.rate_limited": "レート制限中",
  "tui.prompt.retry.attempt": "試行 #{{attempt}} · {{duration}}後に再試行",
  "tui.prompt.retry.retrying": "試行 #{{attempt}} · 再試行中",
  "tui.prompt.retry.expand": "(クリックで展開)",
  "tui.status.working": "作業中…",
  ...
  "tui.session.thinking": "思考中",
  "tui.session.thinking_titled": "思考中: {{title}}",
  "tui.session.thought": "思考",
  "tui.session.interrupted": "中断",
  "tui.tool.pending.asking": "質問中...",
  "tui.tool.pending.writing_command": "コマンドを作成中...",
  "tui.tool.pending.updating_tasks": "タスクを更新中...",
  "tui.tool.pending.writing_script": "スクリプトを作成中...",
  "tui.tool.pending.starting_workflow": "ワークフローを開始中...",
  "tui.tool.pending.preparing_write": "書き込みを準備中...",
  "tui.tool.pending.finding_files": "ファイルを検索中...",
  "tui.tool.pending.reading_file": "ファイルを読み込み中...",
  "tui.tool.pending.viewing_image": "画像を表示中...",
  "tui.tool.pending.searching_content": "内容を検索中...",
  "tui.tool.pending.fetching_web": "Webから取得中...",
  "tui.tool.pending.searching_code": "コードを検索中...",
  "tui.tool.pending.searching_web": "Webを検索中...",
  "tui.tool.pending.delegating": "委任中...",
  "tui.tool.pending.preparing_edit": "編集を準備中...",
  "tui.tool.pending.preparing_patch": "パッチを準備中...",
  "tui.tool.pending.asking_questions": "質問中...",
  "tui.tool.pending.loading_skill": "スキルを読み込み中...",
  ...
  "tui.dialog.auto_free_setup.title": "無料プロバイダを設定（Auto）",
  "tui.dialog.auto_free_setup.hint": "Zen 無料モデルはキー不要。追加の無料枠には各社のアカウントと API キーが必要です。",
  "tui.dialog.auto_free_setup.category": "無料 API キー",
  "tui.dialog.auto_free_setup.connected": "接続済み — Auto（無料）で利用可能",
  "tui.dialog.auto_free_setup.needs_key": "アカウント作成後、API キーを貼り付け",
  "tui.dialog.auto_free_setup.done": "完了",
  "tui.dialog.auto_free_setup.done_desc": "戻る — OpenCode Zen の無料モデルはキーなしで使えます",
  "tui.dialog.auto_free_setup.key_title": "{{name}} の API キー",
  "tui.dialog.auto_free_setup.open_signup": "登録 / キー発行:",
  "tui.dialog.auto_free_setup.paste_key": "下に API キーを貼り付けて Enter。",
  "tui.dialog.auto_free_setup.saved": "{{name}} を接続しました — Auto（無料）で使えます",
  "tui.command.provider.auto_free_setup.title": "無料プロバイダを設定",
  "tui.command.auto_mode.title": "オートモードを切り替え",
  "tui.dialog.auto_mode.title": "オートモード",
  "tui.dialog.auto_mode.hint": "none / se / fde / special — セッション単位の切替（global は /auto default）",
  "tui.dialog.auto_mode.current": "現在",
  "tui.dialog.auto_mode.option.none.title": "none",
  "tui.dialog.auto_mode.option.none.desc": "オフ — 判断時に質問し、権限は承認が必要",
  "tui.dialog.auto_mode.option.se.title": "se",
  "tui.dialog.auto_mode.option.se.desc": "ヒアリング先行（あなたに質問）→ 要件ロック後にノンストップ",
  "tui.dialog.auto_mode.option.normal.title": "normal（se の別名）",
  "tui.dialog.auto_mode.option.normal.desc": "非推奨の別名 — se と同じ（ヒアリング先行 → 要件ロック後ノンストップ）",
  "tui.dialog.auto_mode.option.fde.title": "fde",
  "tui.dialog.auto_mode.option.fde.desc":
    "Forward Deployed Engineer — 現場課題を定義し Level1–3 提案・PoC 後に Solution Lock、実装まで",
  "tui.dialog.auto_mode.option.special.title": "special",
  "tui.dialog.auto_mode.option.special.desc":
    "疑問は自分で立てて自分で答え、待たずに続行（席を外してOK）",
  "tui.dialog.auto_mode.warn.title": "special（Super Auto）を有効にしますか？",
  "tui.dialog.auto_mode.warn.body":
    "special は SE と同じ疑問を立てたうえで、自分で答えを決め、ユーザーを待たずに続行します。待ち中の質問は自動解決されます。ツールは追加確認なしで動くことがあります。",
  "tui.dialog.auto_mode.warn.refuse": "拒否する（推奨）",
  "tui.dialog.auto_mode.warn.refuse_desc": "前のモードのままにする",
  "tui.dialog.auto_mode.warn.confirm": "理解した — special を有効にする",
  "tui.dialog.auto_mode.warn.confirm_desc": "残りの疑問は自己回答し、ノンストップで完了まで進める",
  "tui.dialog.auto_mode.toast.none": "オートモード: none",
  "tui.dialog.auto_mode.toast.se": "オートモード: se（ヒアリング先行）",
  "tui.dialog.auto_mode.toast.normal": "オートモード: se（ヒアリング先行；normal は別名）",
  "tui.dialog.auto_mode.toast.fde": "オートモード: fde（Forward Deployed Engineer）",
  "tui.dialog.auto_mode.toast.special": "オートモード: special — 自己回答してノンストップ続行",
