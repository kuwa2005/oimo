export const dict: Record<string, string> = {
  ...
  "tui.home.agreement.prefix": "By using Open Mimo Code, you agree to our ",
  ...
  "tui.prompt.retry.rate_limited": "Rate limited",
  "tui.prompt.retry.attempt": "attempt #{{attempt}} · retrying in {{duration}}",
  "tui.prompt.retry.retrying": "attempt #{{attempt}} · retrying",
  "tui.prompt.retry.expand": "(click to expand)",
  "tui.status.working": "Working…",
  "tui.status.writing_checkpoint": "Writing checkpoint…",
  "tui.status.rebuilding_context": "Rebuilding context…",
  "tui.status.preparing_context": "Preparing conversation context…",
  "tui.session.thinking": "Thinking",
  "tui.session.thinking_titled": "Thinking: {{title}}",
  "tui.session.thought": "Thought",
  "tui.session.interrupted": "interrupted",
  "tui.tool.pending.asking": "Asking...",
  "tui.tool.pending.writing_command": "Writing command...",
  "tui.tool.pending.updating_tasks": "Updating tasks...",
  "tui.tool.pending.writing_script": "Writing script...",
  "tui.tool.pending.starting_workflow": "Starting workflow...",
  "tui.tool.pending.preparing_write": "Preparing write...",
  "tui.tool.pending.finding_files": "Finding files...",
  "tui.tool.pending.reading_file": "Reading file...",
  "tui.tool.pending.viewing_image": "Viewing image...",
  "tui.tool.pending.searching_content": "Searching content...",
  "tui.tool.pending.fetching_web": "Fetching from the web...",
  "tui.tool.pending.searching_code": "Searching code...",
  "tui.tool.pending.searching_web": "Searching web...",
  "tui.tool.pending.delegating": "Delegating...",
  "tui.tool.pending.preparing_edit": "Preparing edit...",
  "tui.tool.pending.preparing_patch": "Preparing patch...",
  "tui.tool.pending.asking_questions": "Asking questions...",
  "tui.tool.pending.loading_skill": "Loading skill...",
  ...
  "tui.tips.free_api_sunset":
    "The free API service has ended. Run {highlight}/login{/highlight} to sign in. Subscribe to the MiMo Token Plan or configure a third-party API to use Open Mimo Code.",
  ...
  "tui.tips.config_files":
    "Create {highlight}oimo.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "tui.tips.global_config": "Place TUI settings in {highlight}~/.config/oimo/tui.json{/highlight} for global config",
  ...
  "tui.tips.mcp_oauth": "Open Mimo Code auto-handles OAuth for remote MCP servers requiring auth",
  "tui.tips.custom_command":
    "Add {highlight}.md{/highlight} files to {highlight}.oimo/command/{/highlight} to define reusable custom prompts",
  ...
  "tui.tips.custom_agent":
    "Add {highlight}.md{/highlight} files to {highlight}.oimo/agent/{/highlight} for specialized AI personas",
  ...
  "tui.tips.formatter": "Open Mimo Code auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "Open Mimo Code uses LSP servers for intelligent code analysis",
  "tui.tips.custom_tool":
    "Create {highlight}.ts{/highlight} files in {highlight}.oimo/tools/{/highlight} to define new LLM tools",
  "tui.tips.tool_scripts": "Tool definitions can invoke scripts written in Python, Go, etc",
  "tui.tips.plugins":
    "Add {highlight}.ts{/highlight} files to {highlight}.oimo/plugin/{/highlight} for event hooks",
  "tui.tips.plugin_notify": "Use plugins to send OS notifications when sessions complete",
  "tui.tips.plugin_protect": "Create a plugin to prevent Open Mimo Code from reading sensitive files",
  "tui.tips.run": "Use {highlight}oimo run{/highlight} for non-interactive scripting",
  "tui.tips.continue": "Use {highlight}oimo --continue{/highlight} to resume the last session",
  "tui.tips.attach_cli": "Use {highlight}oimo run -f file.ts{/highlight} to attach files via CLI",
  "tui.tips.format_json": "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "tui.tips.serve": "Run {highlight}oimo serve{/highlight} for headless API access to Open Mimo Code",
  "tui.tips.attach_server": "Use {highlight}oimo run --attach{/highlight} to connect to a running server",
  "tui.tips.upgrade": "Run {highlight}oimo upgrade{/highlight} to update to the latest version",
  "tui.tips.auth_list": "Run {highlight}oimo auth list{/highlight} to see all configured providers",
  "tui.tips.agent_create": "Run {highlight}oimo agent create{/highlight} for guided agent creation",
  "tui.tips.github_install": "Run {highlight}oimo github install{/highlight} to set up the GitHub workflow",
  ...
  "tui.tips.theme_files": "Create JSON theme files in {highlight}.oimo/themes/{/highlight} directory",
  ...
  "tui.tips.debug_config": "Run {highlight}oimo debug config{/highlight} to troubleshoot configuration",
  ...
  "tui.tips.zen": "Use {highlight}/connect{/highlight} with Open Mimo Code for curated, tested models",
  ...
  "tui.skill.drive-mimo.description": "Programmatically drive another Open Mimo Code process — headless JSON events or interactive TUI via tmux",
  ...
  "tui.context_limit.scalar_config": "compaction.max_context is set to a single value for all models — edit it in oimo.json to switch to per-model limits",
  "tui.context_limit.shadowed": "Saved, but another config still forces {{value}} — check your project oimo.json",
  ...
  "tui.dialog.free_api_sunset.message":
    "Run /login to sign in. Subscribe to the MiMo Token Plan or configure a third-party API to use Open Mimo Code.",
  ...
  "tui.dialog.auto_free_setup.title": "Setup free providers (Auto)",
  "tui.dialog.auto_free_setup.hint": "Zen free models work with no key. Add keys to unlock more free quotas.",
  "tui.dialog.auto_free_setup.category": "Free API keys",
  "tui.dialog.auto_free_setup.connected": "Connected — available to Auto (free)",
  "tui.dialog.auto_free_setup.needs_key": "Create an account, then paste an API key",
  "tui.dialog.auto_free_setup.done": "Done",
  "tui.dialog.auto_free_setup.done_desc": "Return — OpenCode Zen free models already work without keys",
  "tui.dialog.auto_free_setup.key_title": "{{name}} API key",
  "tui.dialog.auto_free_setup.open_signup": "Signup / keys:",
  "tui.dialog.auto_free_setup.paste_key": "Paste the API key below, then Enter.",
  "tui.dialog.auto_free_setup.saved": "{{name}} connected — Auto (free) can use it now",
  "tui.command.provider.auto_free_setup.title": "Setup free providers",
  "tui.command.auto_mode.title": "Switch auto mode",
  "tui.dialog.auto_mode.title": "Auto mode",
  "tui.dialog.auto_mode.hint": "none / se / fde / special — mid-session switch (session-scoped; use /auto default for global)",
  "tui.dialog.auto_mode.current": "Current",
  "tui.dialog.auto_mode.option.none.title": "none",
  "tui.dialog.auto_mode.option.none.desc": "Off — ask at decisions; permissions need approval",
  "tui.dialog.auto_mode.option.se.title": "se",
  "tui.dialog.auto_mode.option.se.desc": "Hearing first with you, then non-stop after Requirements Lock",
  "tui.dialog.auto_mode.option.normal.title": "normal (alias of se)",
  "tui.dialog.auto_mode.option.normal.desc": "Deprecated alias of se — hearing first, then non-stop after Requirements Lock",
  "tui.dialog.auto_mode.option.fde.title": "fde",
  "tui.dialog.auto_mode.option.fde.desc":
    "Forward Deployed Engineer — frame the field problem, Level 1–3 options, PoC, then Solution Lock and implement",
  "tui.dialog.auto_mode.option.special.title": "special",
  "tui.dialog.auto_mode.option.special.desc":
    "Raise doubts, self-answer, never wait — continue non-stop (leave your seat)",
  "tui.dialog.auto_mode.warn.title": "Enable special (Super Auto)?",
  "tui.dialog.auto_mode.warn.body":
    "Special raises the same questions an SE would, then answers them itself and continues without waiting. Pending questions are auto-resolved. Tools may run without further confirmation.",
  "tui.dialog.auto_mode.warn.refuse": "Refuse (recommended)",
  "tui.dialog.auto_mode.warn.refuse_desc": "Stay on the previous mode",
  "tui.dialog.auto_mode.warn.confirm": "I understand — enable special",
  "tui.dialog.auto_mode.warn.confirm_desc": "Self-answer remaining doubts and finish non-stop",
  "tui.dialog.auto_mode.toast.none": "Auto mode: none",
  "tui.dialog.auto_mode.toast.se": "Auto mode: se (hearing first)",
  "tui.dialog.auto_mode.toast.normal": "Auto mode: se (hearing first; normal is an alias)",
  "tui.dialog.auto_mode.toast.fde": "Auto mode: fde (Forward Deployed Engineer)",
  "tui.dialog.auto_mode.toast.special": "Auto mode: special — self-answer and continue non-stop",
  ...
  "tui.dialog.model.free_no_config_category": "Free · No setup",
  "tui.dialog.model.free_api_key_category": "Free · API key",
  ...
  "tui.toast.update_available.success": "Successfully updated to Open Mimo Code v{{version}}. Please restart the application.",
  ...
  "cli.providers.mimo_free.usage_hint": "No login required — just run oimo. For paid/premium models, choose MiMo browser login instead.",
  ...
  "trust.capabilities": "Open Mimo Code will be able to read, edit, and execute files here.",
