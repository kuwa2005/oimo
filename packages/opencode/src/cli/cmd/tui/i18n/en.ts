export const dict: Record<string, string> = {
  ...
  "tui.dialog.auto_mode.hint": "none / normal / fde / special — mid-session switch keeps the current goal (no restart)",
  ...
  "tui.dialog.auto_mode.option.normal.title": "normal",
  "tui.dialog.auto_mode.option.normal.desc": "Hearing first with you, then non-stop after Requirements Lock",
  ...
  "tui.dialog.auto_mode.toast.normal": "Auto mode: normal (hearing first)",
